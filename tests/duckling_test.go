...
func TestParameters_Duckling(t *testing.T) {
	t.Parallel()
	...
	optionsWithValues := &helm.Options{
		SetValues: map[string]string{
			"duckling.podLabels.test_label": "test_value",
		},
	...
	outputWithOptions := helm.RenderTemplate(t, optionsWithValues, helmChartPath, releaseName, []string{"templates/duckling-deployment.yaml"})
	outputWithoutOptions := helm.RenderTemplate(t, optionsWithoutValues, helmChartPath, releaseName, []string{"templates/duckling-deployment.yaml"})
