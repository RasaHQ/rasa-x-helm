...
| `rasax.tag`                            | Version of Rasa X which you want to use.                                                                                                                                                     | `1.1.0`            |
| `rasa.version`                         | Version of Rasa Open Source which you want to use.                                                                                                                                           | `3.1.0`            |
...
| `app.tag`                              | Tag of your action server image.                                                                                                                                                             | `1.1.0a1`          |
